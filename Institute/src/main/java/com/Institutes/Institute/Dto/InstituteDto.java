package com.Institutes.Institute.Dto;
...
public class InstituteDto {
    ...
    public InstituteDto(int id, String name, String courses, String price, Long mentors, byte[] photo) {
        this.id = id;
        this.name = name;
    ...
    public InstituteDto(String name, String courses, String price, Long mentors, byte[] photo) {
        this.name = name;
        this.courses = courses;
        this.price = price;
        this.mentors = mentors;
